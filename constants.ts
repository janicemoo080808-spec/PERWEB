...
const CRYDIT_SECTIONS_CN = [
  ...
  { title: '社交叙事与 IP 人格化', label: 'SOCIAL VOICE', icon: 'Twitter', isSlider: true, description: '在社交平台构建具有温度的 IP 叙事，将 Web3 叙事转化为感性内容分析。', images: ['https://cdn.jsdelivr.gh/gh/janicemoo080808-spec/picx-images-hosting@master/6.3k8hjkbw3b.webp', 'https://cdn.jsdelivr.gh/gh/janicemoo080808-spec/picx-images-hosting@master/Frame-2087326827.wj17v1a1b.webp', 'https://cdn.jsdelivr.gh/gh/janicemoo080808-spec/picx-images-hosting@master/image-2475.4ubeojcaob.webp', 'https://cdn.jsdelivr.gh/gh/janicemoo080808-spec/picx-images-hosting@master/Twitter--post-16.24.53.9rjvidq2h4.webp'] },
...
export const PROJECTS_CN: Project[] = [
  ...
  { 
    ...
    description: 'LVMH 美学体系下的视觉叙事与内容排版分析。', 
...
export const PROJECTS_EN: Project[] = [
  ...
  },
  {
    ...
    category: 'ACTIVITY_VISUALS',
    subCategory: 'CAMPAIGN',
    description: 'Multi-dimensional offline event visual communication.',
    imageUrl: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?q=80&w=1920',
    tags: ['Event Visuals', 'Exhibition'],
    sections: ACTIVITY_SECTIONS as any
  }
];
...
const EXPERIENCE_CN: ExperienceItem[] = [
  {
    ...
    reportingTo: 'CEO',
    responsibilities: [
      '品牌策略与管理：从0到1建立并实施 brand 战略，分析市场趋势和竞争对手，制定 brand 推广计划，提升 brand 知名度和市场份额。',
      '创意与设计管理：领导设计团队从0到1创建 brand 视觉识别系统，监督广告、包装、数据和活动设计等项目，确保设计创新且符合 brand 调性。',
      '跨部门合作：与市场营销、产品开发、销售等部门紧密合作，协调外部供应商和合作伙伴，确保 brand 项目高质量完成。',
      '品牌传播与推广：规划和执行 brand 传播活动，管理 brand 在各渠道的传播内容，组织 brand 推广活动和国际展会，提升 brand 市场影响力。',
  ...
  },
  {
    ...
    responsibilities: [
      ...
      '外联管理：作为 brand 设计负责人，对接各部门和供应商，协调跨职能工作关系，主导项目沟通。',
  ...
  },
  {
    ...
    reportingTo: 'CMO营销总裁',
    responsibilities: [
      '视觉管理：协助CMO营销总裁，负责中国贵酒集团、海银集团、中国花王集团、章贡酒业、美酒链公司等子公司的设计质量审核与监督。基于 brand 设计DNA，持续生成并维护 brand 视觉识别系统（Brandbook及Guideline），确保 brand 在各个触点的一致性和高质量呈现。',
    ...
    achievements: [
      ...
      '创新案例：“千城万企”项目在国际高品质消费博览会上被评为十大高品质消费创新案例，提升集团 brand 影响力和市场美誉度。'
    ]
  },
  {
    id: 'exp-chunmai',
    ...
    responsibilities: [
      ...
      '团队管理：组建并领导 brand 设计团队，负责团队绩效管理与辅导。',
  ...
  },
  {
    ...
    responsibilities: [
      ...
      '针对节日/项目需求，设计不同风格页面，对产品整体风格和 brand 调性负责。'
    ]
  }
];
...
export const STRATEGIC_EXPERTISE_CN = [
  ...
  { title: "团队领导与协作", desc: "擅长领导和协调团队，推动项目落地，实现卓越的 brand 表现。" }
];
